...
void studentsManager(){
    ...
    while (1) {
        ...
        scanf("%d", &choice);
        switch (choice) {
            case 1: scoreinput(stuscorelib); break;
            case 2: scoremodify(stuscorelib); break;
            case 3: scorequery(stuscorelib); break;
            case 4: selectAndBrowse(stuscorelib); break;
            case 5: scoredelete(stuscorelib); break;
            case 6: classscoresort(stuscorelib);break;
            case 7: readDataFromFile(stuscorelib);break;
            case 8: readDatabase();break;
            case 9: flag = 1; break;
